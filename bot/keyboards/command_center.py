...
def operations_menu_kb() -> InlineKeyboardMarkup:
    ...
    builder.button(text="🎯 عملیات ترور", callback_data="op:new:assassination", style=STYLE_NO)
    builder.button(text="⚓ رهگیری محموله", callback_data="op:new:interception", style=STYLE_NO)
